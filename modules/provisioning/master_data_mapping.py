...
class MasterDataMappingStore(Protocol):
    ...
    def put(self, *, engine_instance_id: str, legal_entity_id: str, kind: str, canonical_id: str, native_id: int, desired_digest: str) -> None: ...
...
class PostgresMasterDataMappingStore:
    ...
    def put(self, *, engine_instance_id, legal_entity_id, kind, canonical_id, native_id, desired_digest):
        with self._connection.cursor() as c:
            c.execute("""INSERT INTO baobab.erp_master_data_mapping
              ...
              (engine_instance_id,legal_entity_id,kind,canonical_id,native_id,desired_digest))
